...
const Landing = () => {
    return (
      <div> 
        ...
        <section id="about" class="bg-light d-flex flex-column align-items-center mt-0">
            <h1 className="text-muted my-4">ABOUT US</h1>
            <div className='row h-100'>
                <div className='col-sm-6'>
                  <div className='d-flex container justify-content-center'>
                    <img src={'IMG-20231028-WA0001.jpg'} className=' mx-2 w-100 rounded'></img>
                  </div>
                </div>
                <div className='col-sm-6'>
                  <div className=''>
                    ...
                    <a class="d-flex btn btn-outline-secondary justify-content-center" data-bs-toggle="collapse" href="#about-more" role="button" aria-expanded="false" aria-controls="about-more">
                        Show more
                    </a>
                  </div>
                </div>
        ...
        <div id="about-more" className='collapse'>
          <section id="about-more" class="collapse bg-light d-flex flex-column align-items-center mt-0">
          <div class="row">
  <div class="col-sm-6">
