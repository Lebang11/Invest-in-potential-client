...
const Landing = () => {
    ...
    return (
      <div> 
        ...
        <section id="about" class="bg-light d-flex flex-column align-items-center bg-light">
          <div className='container-xl bg-light'>
            <h1 className="text-muted my-4 text-center">ABOUT US</h1>
            <div className='row container-xl mb-4 overflow-auto' style={{"max-height": "40vh"}}>
                ...
                <div className='col-sm-6 '>
                  <div className='container ' >
                    ...
                    <a class="d-flex btn btn-outline-secondary justify-content-center" data-bs-toggle="collapse" href="#about-more" role="button" aria-expanded="false" aria-controls="about-more" onClick={() => {
        ...
        <div id="about-more" className='collapse bg-light h-100 w-100 pt-4'>
